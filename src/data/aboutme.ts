...
export const aboutMe: AboutMe = {
  ...
  description:
    "<p>Hi! I am a first year Computer Science PhD student at <a href='https://www.wisc.edu'>University of Wisconsin–Madison</a> working with <a href='https://pages.cs.wisc.edu/~fredsala/'>Fred Sala</a> and <a href='https://tengyangxie.github.io/'>Tengyang Xie</a>. As an undergraduate at <a href='https://www.brown.edu/'>Brown University</a>, I was fortunate to work with <a href='https://cs.brown.edu/people/sbach/'>Stephen Bach</a>.</p>" +
    "<br>" +
    "<p>My research interests include synthetic data, data-centric ML, and reasoning. My recent emphasis has been on tailoring data for LLMs, and understanding the role that data plays. Feel free to reach out to chat about ideas!</p>",
